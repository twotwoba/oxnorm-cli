...
import { detectLegacyConfigFiles, promptLegacyCleanup, removeLegacyFiles } from "../modules/legacy-cleanup";
...
export async function initCommand(options: InitOptions): Promise<void> {
	...
	if (!options.skipVersionCheck) {
		...
		versionSpinner.succeed(`Node.js version ${versionResult.currentVersion} (>= ${versionResult.minVersion})`);
	} else {
